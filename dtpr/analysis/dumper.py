"""Analysis dispatch for the ``dtpr dump`` command.
...
logic to :func:`dtpr.utils.io.dump_to_root` or :func:`dtpr.utils.io.dump_to_parquet`.
...
- **Parquet** (``-p`` / ``--to-parquet``): The full awkward array is written 
  ...
  can be reloaded by :class:`~dtpr.base.ntuple.NTuple` for further 
...
from ..base.io import dump_to_root, dump_to_parquet
