...
from src.utils.gui.mplwidget import PlotWidget  # Import PlotWidget
from src.analysis.plot_dt_chambers import embed_dtwheel2axes
from src.analysis.plot_dt_chamber import embed_dt2axes
